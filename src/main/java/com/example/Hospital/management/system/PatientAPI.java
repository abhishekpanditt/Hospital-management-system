...
public class PatientAPI {
    ...
    @PostMapping("/addPatientViaParamaters")            //adding patients
    ...
    @PostMapping("/addPatientViaRequestBody")           //adding patients by patientId
    ...
    @GetMapping("/getPatientInfo")                      //searching patients by patientId
    ...
    @GetMapping("/getAllPatients")                      //searching all patients
    ...
    @GetMapping("/getPatientByName")                    //searching patients by name
    ...
    @GetMapping("/getPatientsListGreaterThanAge")       //searching patients having age greater than entered age
